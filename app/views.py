...
def feedbackk(request):
    ...
    internet = {'1': 'Маникюр/педикюр', '2': 'Парикмахерские услуги', '3': 'Косметология', 
                '4': 'Пирсинг','5': 'Коррекция/окрашивание бровей', '6': 'Моментальный загар'}
